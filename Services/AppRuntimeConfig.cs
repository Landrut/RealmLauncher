...
namespace RealmLauncher.Services
{
    public static class AppRuntimeConfig
    {
        ...
        public const string WebsiteUrl = "https://realm-rp.com/";
        ...
        public const string DiscordDefaultPlayingDetails = "Играет на сервере";
        public const string DiscordDefaultLargeText = "REALM RolePlay";

        public const string DiscordDefaultLargeImageKey = "";

        public const string LocalPlayArguments = "";
